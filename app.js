...
=============================== */
const pages = {
home:     <h3>📊 Dashboard</h3>     <p>Your personal Clarity AI workspace.</p>     <ul>     <li>✔ Frontend-only architecture</li>     <li>✔ Web Speech API TTS</li>     <li>✔ Privacy-first design</li>     </ul>    ,
voice:     <h3>🎙️ Voice Assistant</h3>     <p>Convert text into a confident AI voice.</p>     <a href="index.html" style="margin-top:10px;" class="btn-primary">🎙️ Open Voice Studio</a>    ,
notes:     <h3>📝 Notes</h3>     <textarea id="notesArea" style="width:100%;height:120px;" placeholder="Write notes..."></textarea>     <br><br>     <button class="btn-primary" onclick="saveNotes()">Save Notes</button>     <p class="muted" style="margin-top:10px;">Stored locally in your browser.</p>    
};
...
/* Back to dashboard button (Voice Studio) */
